...
export const canvasVariantsTable = pgTable(
  "canvas_variants",
  {
  ...
  (t) => [
    index("canvas_variants_project_idx").on(t.projectId, t.createdAt),
    index("canvas_variants_exploration_idx").on(t.explorationId),
    index("canvas_variants_last_viewed_idx").on(t.lastViewedAt),
    uniqueIndex("canvas_variants_share_token_idx")
      .on(t.shareToken)
 ...
 */
export const canvasVariantLibraryTable = pgTable(
  ...
  (t) => [index("canvas_variant_library_user_idx").on(t.userId, t.createdAt)],
);
 ...
 */
export const canvasAbTestsTable = pgTable(
  "canvas_ab_tests",
  {
    id: serial("id").primaryKey(),
    projectId: integer("project_id")
  ...
  (t) => [index("canvas_ab_tests_project_idx").on(t.projectId, t.createdAt)],
);
