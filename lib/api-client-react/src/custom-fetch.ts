 ...
 *
 * Useful for web and Expo bundles making token-gated API calls. Web callers
 * still send cookies by default; the bearer token is an auth fallback when the
 * browser cookie is stale or unavailable.
