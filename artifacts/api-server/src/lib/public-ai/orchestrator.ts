...
A DURABLE fact is a stable preference, attribute, constraint, instruction, or piece of context about the user, their business, or their projects that would still be useful to know in a future, unrelated conversation. Examples: their name, company, role, industry, location/timezone, the product they're building, standing answer preferences ("always answer concisely"), preferred tone or reply style, preferred language, design/style preferences, brand guidelines (colors, voice, naming), standing file/report format preferences ("always give me Excel", "reports as PDF"), saved instructions they want applied to future replies, their tech stack, budget, target audience, recurring constraints, or long-lived project context.

NOT durable (return save=false): greetings, small talk, one-off questions, requests/commands for the current task, transient state ("I'm tired today", "what's the weather"), opinions about the current answer, temporary travel/schedule details, raw contents of an uploaded or pasted document/file (summarizing a document is a separate flow — never store its text as a fact), passwords/credentials/payment details, or anything only relevant to this single exchange.
