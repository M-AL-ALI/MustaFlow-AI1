...
export function Markdown({ children }: { children: string }) {
  ...
  const styles = {
    ...
    heading1: { color: c.foreground, fontFamily: "Inter_700Bold", fontSize: 20, marginTop: 8, marginBottom: 4 },
    heading2: { color: c.foreground, fontFamily: "Inter_700Bold", fontSize: 18, marginTop: 8, marginBottom: 4 },
    heading3: { color: c.foreground, fontFamily: "Inter_600SemiBold", fontSize: 16, marginTop: 6, marginBottom: 2 },
