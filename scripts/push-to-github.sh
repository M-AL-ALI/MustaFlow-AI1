...
git add artifacts/orax-desktop/src/main/project-fix-drafter.ts 2>/dev/null || true
...
git add artifacts/api-server/src/routes/orax-projects.ts 2>/dev/null || true
