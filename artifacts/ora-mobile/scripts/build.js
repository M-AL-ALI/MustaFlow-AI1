...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  const env = {
    ...
    // Clerk auth — same code runs in dev and prod; env vars are empty in dev
    // and auto-populated in prod. Forward them so the bundled app can boot
    // ClerkProvider in production builds.
