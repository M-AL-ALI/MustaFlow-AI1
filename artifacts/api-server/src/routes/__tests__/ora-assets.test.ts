...
describe.skipIf(process.env.NABUFLOW_VITEST_DATABASE_ENABLED !== "true")("persistOraAsset", () => {
...
describe.skipIf(process.env.NABUFLOW_VITEST_DATABASE_ENABLED !== "true")("GET /ora/assets", () => {
 ...
 */
describe.skipIf(process.env.NABUFLOW_VITEST_DATABASE_ENABLED !== "true")(
  "chat.ts persists generated images to the asset library",
  () => {
...
describe.skipIf(process.env.NABUFLOW_VITEST_DATABASE_ENABLED !== "true")(
  ...
  () => {
    const jobsSrc = readFileSync(
      path.join(__dirname, "../../lib/image-generation-jobs.ts"),
      "utf8",
    );
...
describe.skipIf(process.env.NABUFLOW_VITEST_DATABASE_ENABLED !== "true")(
  "persistOraAsset version lineage",
  () => {
 ...
 */
describe.skipIf(process.env.NABUFLOW_VITEST_DATABASE_ENABLED !== "true")(
  "edited-file persist paths chain version lineage",
  () => {
    const chatSrc = readFileSync(path.join(__dirname, "../public-ai/chat.ts"), "utf8");
