...
const clerkAppearance = {
  ...
  elements: {
    ...
    formButtonPrimary:
      "bg-cyan-500 hover:bg-cyan-400 text-black font-semibold shadow-none",
    formFieldInput:
      "bg-zinc-900 border-zinc-700 text-white placeholder:text-zinc-600 focus:border-cyan-500",
