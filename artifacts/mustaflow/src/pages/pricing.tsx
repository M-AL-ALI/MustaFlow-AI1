...
const TIERS = [
  {
    ...
    cost: 1,
    model: "gpt-5-mini",
    tagline: "Minimal correct change",
  ...
  },
  {
    ...
    cost: 5,
    model: "gpt-5-nano",
    tagline: "Production-ready TypeScript",
    color: "text-primary",
    bg: "bg-primary/5",
  ...
  },
  {
    ...
    cost: 10,
    model: "gpt-5.4",
    tagline: "Security-first strict mode",
