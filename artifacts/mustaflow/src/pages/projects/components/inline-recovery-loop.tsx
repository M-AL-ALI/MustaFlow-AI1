...
export function InlineRecoveryLoop({
  ...
  return (
    <section className={cn("space-y-1.5 text-xs", className)} data-testid="inline-recovery-loop">
      ...
      {recoveryFailed && onRetry && (
        <button
          type="button"
          onClick={onRetry}
          className="ml-5 inline-flex items-center gap-1 rounded-sm text-[10px] font-medium text-foreground outline-none transition-colors hover:text-primary focus-visible:ring-2 focus-visible:ring-ring"
        >
