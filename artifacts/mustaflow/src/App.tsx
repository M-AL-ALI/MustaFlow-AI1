...
const OraxWorkspacePage = lazy(() => import("./pages/orax-workspace"));
const OraxDesktopAuthApprovePage = lazy(() => import("./pages/orax-desktop-auth-approve"));
const KnowledgePage = builderLazy(() => import("./pages/knowledge"));
const VaultPage = builderLazy(() => import("./pages/vault"));
const MemoryPage = builderLazy(() => import("./pages/memory"));
const LibraryPage = builderLazy(() => import("./pages/library"));
...
const LearnPage = builderLazy(() => import("./pages/learn"));
const PricingPage = lazy(() => import("./pages/pricing"));
const WorkspaceUsagePage = builderLazy(() => import("./pages/workspace-usage"));
const WorkspaceAuditPage = builderLazy(() => import("./pages/workspace-audit"));
const MyDomainsPage = builderLazy(() => import("./pages/account/domains"));
const WorkspaceDomainsPage = builderLazy(() => import("./pages/workspace-domains"));
const OrgSettingsPage = builderLazy(() => import("./pages/org-settings"));
const OrgNewPage = builderLazy(() => import("./pages/org-new"));
...
const ImageStudioPage = builderLazy(() => import("./pages/image-studio"));
            ...
            <TooltipProvider>
              <Suspense fallback={null}>
                <Switch>
                  ...
                  <Route path="/orax/desktop-auth/approve">
                    <Protected>
                      <OraxDesktopAuthApprovePage />
                    </Protected>
                  </Route>
                  <Route path="/orax/workspace/:projectId">
                    <Protected>
                      <OraxWorkspacePage />
                    </Protected>
                  </Route>
                  <Route path="/orax/workspace">
                    <Protected>
                      <OraxWorkspacePage />
                    </Protected>
                  </Route>
