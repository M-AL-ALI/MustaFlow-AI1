// ─────────────────────────────────────────────────────────────────────────────
// Credits — pure business-logic helpers (no Express dependency).
//
// Extracted from routes/credits.ts so lib/jobs.ts and other lib modules can
// import these without dragging in the Express Request augmentation, which
// breaks the scripts/ workspace typecheck.
// ─────────────────────────────────────────────────────────────────────────────
...
export async function refundCredits(
  ...
  try {
    const { nabuflowChargeActive, maybeRefundNabuflow } = await import("./nabuflow-billing");
...
// ─── Transaction history helper used by route ────────────────────────────────
