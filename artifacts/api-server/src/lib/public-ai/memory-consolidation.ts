...
const STOPWORDS = new Set([
  ...
  "to", "of", "for", "in", "on", "at", "by", "with", "from", "into", "about",
  "as", "it", "its", "i", "me", "my", "mine", "we", "us", "our", "you", "your",
  "he", "she", "they", "them", "their", "his", "her", "do", "does", "did",
  "have", "has", "had", "will", "would", "should", "could", "can", "may",
  "might", "must", "shall", "not", "no", "yes", "so", "very", "just", "also",
  "too", "please", "remember", "forget", "note", "save", "saving", "want",
  "wants", "wanted", "like", "likes", "liked", "when", "what", "who", "how",
  "why", "where", "which", "always", "usually", "really",
]);
