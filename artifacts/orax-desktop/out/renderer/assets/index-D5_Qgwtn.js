...
const host = {
  ...
  updatePermissionMode: (mode) => api().host.updatePermissionMode(mode)
};
const pairing = {
...
const project = {
  ...
  removeLocalFolder: (id) => api().project.removeLocalFolder(id)
};
const events = {
  onHostStateChanged: (cb) => api().on.hostStateChanged(cb),
  onPairingStateChanged: (cb) => api().on.pairingStateChanged(cb)
};
const AppCtx = reactExports.createContext(null);
function AppProvider({ children }) {
  const [session, setSession] = reactExports.useState(null);
  const [hostState, setHostState] = reactExports.useState(null);
  const [pairingState, setPairingState] = reactExports.useState(null);
  const [localProjects, setLocalProjects] = reactExports.useState([]);
  const [isLoadingSession, setIsLoadingSession] = reactExports.useState(true);
  ...
  const registerHost = reactExports.useCallback(async () => {
    const state = await host.register();
    setHostState(state);
  }, []);
  const updatePermissionMode = reactExports.useCallback(async (mode) => {
...
function Sidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 16px 12px", borderBottom: "1px solid var(--border)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 700, fontSize: 16, color: "var(--text-primary)", letterSpacing: "-0.02em" }, children: "Orax Desktop" }),
          hostState && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, marginTop: 6 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `status-dot ${hostState.status}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "var(--text-secondary)" }, children: hostState.status === "online" ? "Online" : hostState.status === "reconnecting" ? "Reconnecting…" : "Offline" })
          ] })
        ] }),
        session && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "12px 16px", borderBottom: "1px solid var(--border)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "var(--text-primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: session.displayName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-secondary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: session.email })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { style: { flex: 1, padding: "8px 8px", overflowY: "auto" }, children: NAV_ITEMS.map(({ page, label, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "8px 8px 12px", borderTop: "1px solid var(--border)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleQuestionMark, { size: 15 }),
                "Help & Support"
              ]
            }
          ),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 44, height: 44, borderRadius: 12, background: "var(--accent)", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 24, color: "#fff" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 700, fontSize: 20, color: "var(--text-primary)" }, children: "Orax Desktop" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "var(--text-secondary)" }, children: "Connect your computer to MustaFlow" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--text-secondary)", textAlign: "center", lineHeight: 1.6 }, children: "Sign in with your MustaFlow account to register this computer as an Orax host. Clicking the button opens your browser — full device-flow sign-in will be active in a future update." }),
              error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "var(--danger-dim)", border: "1px solid var(--danger)", borderRadius: "var(--radius-sm)", padding: "8px 12px", fontSize: 13, color: "var(--danger)" }, children: error }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  disabled: busy,
                  children: busy ? "Opening browser…" : "Sign in with MustaFlow"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 11, color: "var(--text-muted)", textAlign: "center" }, children: "Sign-in opens in your default browser. No password is entered here." })
            ]
          }
        )
      ]
...
function SetupScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 44, height: 44, borderRadius: 12, background: "var(--accent)", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ServerCog, { size: 24, color: "#fff" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 700, fontSize: 20, color: "var(--text-primary)" }, children: "Set Up This Computer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "var(--text-secondary)" }, children: "Register as an Orax host" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { width: "100%", maxWidth: 420, display: "flex", flexDirection: "column", gap: 16 }, children: [
          session && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", background: "var(--accent-dim)", borderRadius: "var(--radius-sm)", border: "1px solid var(--accent)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14, color: "var(--accent)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 13, color: "var(--accent)" }, children: [
              "Signed in as ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: session.displayName })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--text-secondary)", lineHeight: 1.6 }, children: "Registering this computer lets you pair it with your phone or browser to receive and approve actions remotely. You control what Orax can do through permission modes." }),
          ...
          ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "flex-start", gap: 8, fontSize: 13, color: "var(--text-secondary)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14, color: "var(--success)", style: { marginTop: 2, flexShrink: 0 } }),
            item
          ] }, item)) }),
          error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "var(--danger-dim)", border: "1px solid var(--danger)", borderRadius: "var(--radius-sm)", padding: "8px 12px", fontSize: 13, color: "var(--danger)" }, children: error }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              disabled: busy,
              children: busy ? "Registering…" : "Register This Computer"
            }
          )
        ] })
      ]
...
function HomeScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 640, display: "flex", flexDirection: "column", gap: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: 22, fontWeight: 700, color: "var(--text-primary)" }, children: "Orax Desktop" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--text-secondary)", marginTop: 4 }, children: "This computer is registered as a trusted Orax host." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { display: "flex", alignItems: "center", gap: 16 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `status-dot ${hostState.status}`, style: { width: 12, height: 12 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, fontSize: 15, color: "var(--text-primary)" }, children: statusLabel }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-secondary)", marginTop: 2 }, children: "Heartbeat every 30 seconds" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label", children: "Device" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginTop: 4 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 14, color: "var(--text-secondary)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13, color: "var(--text-primary)" }, children: hostState.deviceName })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label", children: "Platform" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginTop: 4 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { size: 14, color: "var(--text-secondary)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13, color: "var(--text-primary)", textTransform: "capitalize" }, children: hostState.platform })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label", children: "Permission Mode" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginTop: 4 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 14, color: "var(--text-secondary)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13, color: "var(--text-primary)" }, children: PERMISSION_MODE_LABELS[hostState.permissionMode] ?? hostState.permissionMode })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label", children: "App Version" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 13, color: "var(--text-primary)", marginTop: 4 }, children: [
          "v",
          hostState.appVersion
        ] })
      ] })
    ] }),
    hostState.hostId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label", children: "Host ID" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, fontFamily: "monospace", color: "var(--text-secondary)", marginTop: 4, wordBreak: "break-all" }, children: hostState.hostId })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { background: "var(--accent-dim)", border: "1px solid var(--accent)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "var(--accent)", fontWeight: 600, marginBottom: 4 }, children: "Phase 2C — Skeleton Only" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-secondary)", lineHeight: 1.6 }, children: "Capabilities are disabled. Shell, filesystem, git, and browser access will be enabled in future phases after explicit permission setup." })
    ] })
  ] });
}
...
function PairingScreen() {
  ...
  const isExpired = pairingState?.expiresAt ? new Date(pairingState.expiresAt).getTime() <= Date.now() : false;
  ...
  if (!hostState?.hostId) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 13 }, children: "Host not registered. Complete setup first." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 480, display: "flex", flexDirection: "column", gap: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: 22, fontWeight: 700, color: "var(--text-primary)" }, children: "Pair a Device" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--text-secondary)", marginTop: 4 }, children: "Generate a code to pair your phone or browser with this computer." })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "var(--danger-dim)", border: "1px solid var(--danger)", borderRadius: "var(--radius-sm)", padding: "10px 14px", fontSize: 13, color: "var(--danger)" }, children: error }),
    pairingState?.isActive && !isExpired ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label", children: "Pairing Code" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          ...
          marginTop: 8
        }, children: pairingState.code }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 13, color: "var(--text-secondary)", marginTop: 8 }, children: [
          "Expires in ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "var(--text-primary)" }, children: countdown })
        ] })
      ] }),
      pairingState.qrPayload && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "var(--bg-elevated)", borderRadius: "var(--radius-sm)", padding: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "label", children: "QR Payload" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontFamily: "monospace", fontSize: 11, color: "var(--text-secondary)", wordBreak: "break-all", marginTop: 6, lineHeight: 1.5 }, children: pairingState.qrPayload }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-muted)", marginTop: 8 }, children: "QR code rendering will be added in Phase 2D." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-secondary", onClick: () => void handleCreate(), disabled: busy, style: { flex: 1, justifyContent: "center" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 13 }),
          " Refresh"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-danger", onClick: () => void handleCancel(), disabled: busy, style: { flex: 1, justifyContent: "center" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 13 }),
          " Cancel"
        ] })
      ] })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { display: "flex", flexDirection: "column", gap: 16, alignItems: "center", textAlign: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Unplug, { size: 32, color: "var(--text-muted)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 15, fontWeight: 600, color: "var(--text-primary)" }, children: isExpired ? "Code Expired" : "No Active Pairing Code" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "var(--text-secondary)", marginTop: 4 }, children: isExpired ? "Generate a new code to pair a device." : "Generate a code to pair your phone or browser with this computer." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: busy ? "Generating…" : "Generate Pairing Code"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", style: { fontSize: 12, color: "var(--text-muted)", lineHeight: 1.6 }, children: "Pairing codes expire after 10 minutes. The mobile scan flow is added in Phase 2D." })
  ] });
}
function ProjectsScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 600, display: "flex", flexDirection: "column", gap: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: 22, fontWeight: 700, color: "var(--text-primary)" }, children: "Local Projects" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--text-secondary)", marginTop: 4 }, children: "Folders on this computer that Orax can reference." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary", onClick: () => void handleAdd(), disabled: busy, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 }),
        " Add Folder"
      ] })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "var(--danger-dim)", border: "1px solid var(--danger)", borderRadius: "var(--radius-sm)", padding: "10px 14px", fontSize: 13, color: "var(--danger)" }, children: error }),
    localProjects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 12, textAlign: "center", padding: 32 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 32, color: "var(--text-muted)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 15, fontWeight: 600, color: "var(--text-primary)" }, children: "No projects yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "var(--text-secondary)", marginTop: 4 }, children: "Add a local folder to get started." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-secondary", onClick: () => void handleAdd(), disabled: busy, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 13 }),
        " Add Local Folder"
      ] })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: localProjects.map((proj) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "card",
        style: { display: "flex", alignItems: "center", gap: 12 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 16, color: "var(--accent)", style: { flexShrink: 0 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, overflow: "hidden" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "var(--text-primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: proj.displayName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-muted)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: proj.localPath })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-muted)", lineHeight: 1.6 }, children: "Project backend sync is added in a future phase. Folders are stored locally only." })
  ] });
}
...
function SettingsScreen() {
  ...
  const [selected, setSelected] = reactExports.useState(
    hostState?.permissionMode ?? "ask_risky"
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 560, display: "flex", flexDirection: "column", gap: 24 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: 22, fontWeight: 700, color: "var(--text-primary)" }, children: "Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--text-secondary)", marginTop: 4 }, children: "Configure how Orax operates on this computer." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 15, color: "var(--accent)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 600, fontSize: 14, color: "var(--text-primary)" }, children: "Permission Mode" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: PERMISSION_MODES.map((mode) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: selected === mode && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 6, height: 6, borderRadius: "50%", background: "#fff" } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "var(--text-primary)" }, children: PERMISSION_MODE_LABELS[mode] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-secondary)", marginTop: 2, lineHeight: 1.5 }, children: MODE_DESCRIPTIONS[mode] })
            ] })
          ]
        },
        mode
      )) }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "var(--danger-dim)", border: "1px solid var(--danger)", borderRadius: "var(--radius-sm)", padding: "10px 14px", fontSize: 13, color: "var(--danger)", marginTop: 12 }, children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, marginTop: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: "btn btn-primary",
            ...
            children: saved ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              " Saved"
            ] }) : saving ? "Saving…" : "Save Permission Mode"
          }
        ),
        selected !== hostState?.permissionMode && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "var(--text-muted)" }, children: "Unsaved changes" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", style: { fontSize: 12, color: "var(--text-muted)", lineHeight: 1.6 }, children: "Capabilities (shell, filesystem, git) are all disabled in Phase 2C regardless of permission mode. Modes apply to future phases when execution is enabled." })
  ] });
}
...
function App() {
  ...
  if (isLoadingSession) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", height: "100%", color: "var(--text-muted)" }, children: "Loading…" });
  }
  if (!session) return /* @__PURE__ */ jsxRuntimeExports.jsx(SignInScreen, {});
  if (!hostState || hostState.status === "unregistered") return /* @__PURE__ */ jsxRuntimeExports.jsx(SetupScreen, {});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", height: "100%", overflow: "hidden" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { style: { flex: 1, overflowY: "auto", padding: "28px 32px", background: "var(--bg-base)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageContent, {}) })
  ] });
}
const root = document.getElementById("root");
if (!root) throw new Error("Root element not found");
clientExports.createRoot(root).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
