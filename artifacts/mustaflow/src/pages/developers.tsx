  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-12">
      ...
      <Section icon={Lock} title="Authentication">
        ...
        <p>
          Tokens are scoped to your account and carry all your project permissions. Treat them like
          passwords — do not commit them to source control. You can revoke a token at any time from
          Settings without affecting other tokens.
        </p>
      ...
      <Section icon={Terminal} title="Key Endpoints">
        <p>
          Below are the most commonly used endpoints. Full details for each endpoint — request body
          schemas, response shapes, and error codes — are in the{" "}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted/40 border-b border-border">
                ...
                <th className="text-left px-4 py-2.5 font-medium text-foreground text-xs">Path</th>
                <th className="text-left px-4 py-2.5 font-medium text-foreground text-xs">
                  Description
                </th>
                <th className="text-left px-4 py-2.5 font-medium text-foreground text-xs">Scope</th>
      ...
      <Section icon={Key} title="Token Scopes">
        <p>
          ...
          using a PAT is rejected with <InlineCode>403 Forbidden</InlineCode> if the token does not
          hold the scope required by the endpoint. Session-authenticated requests (browser cookies)
          implicitly carry all scopes.
        </p>
        <div className="overflow-x-auto rounded-xl border border-border">
          <table className="w-full text-sm">
            <thead>
        ...
        <p>
          ...
          scopes are specified. You can also scope a token to a single project so it cannot access
          any of your other projects even if the scope allows it.
        </p>
      </Section>
